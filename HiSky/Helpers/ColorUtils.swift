...
import UIKit
class ColorUtils{
    static func nav_background_active()->UIColor{
        return hexStringToUIColor(hex: "#FEEFD9")
    }
    
    static func nav_background_deactive()->UIColor{
        return hexStringToUIColor(hex: "#FFFFFF")
    }
    
    static func view_background()->UIColor{
        return hexStringToUIColor(hex: "#FFFFFF")
    }
    
    static func orange()->UIColor{
        return hexStringToUIColor(hex: "#FF9500")
    }
    
    static func gray()->UIColor{
        return hexStringToUIColor(hex: "#8E8E93")
    }
